...
(function() {
  ...
  function BentoMathmlWithRef(props, ref) {
    ...
    var styles = useMemo(function() {
      return _extends9({}, allowDimensions && dimensions, bentoMathmlStyles);
  ...
  function defineElement() {
    var css = "bento-mathml{display:block;overflow:hidden;position:relative}bento-mathml[inline]{display:inline-block;vertical-align:middle}\n/*# sourceURL=/extensions/amp-mathml/1.0/amp-mathml.css*/";
    if (css) {
