(self.AMP=self.AMP||[]).push({m:0,v:"2110121450050",n:"amp-analytics",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var SessionManager = /* @__PURE__ */ function() {
    function SessionManager2(ampdoc) {
  ...
  var VideoEventTracker = /* @__PURE__ */ function(_EventTracker8) {
    ...
    function VideoEventTracker2(root) {
      ...
      Object.keys(VideoAnalyticsEvents).forEach(function(key) {
        _this14.root.getRoot().addEventListener(VideoAnalyticsEvents[key], _this14.boundOnSession_);
      });
      return _this14;
    }
    ...
    _proto12.dispose = function dispose() {
      ...
      var root = this.root.getRoot();
      Object.keys(VideoAnalyticsEvents).forEach(function(key) {
        root.removeEventListener(VideoAnalyticsEvents[key], _this15.boundOnSession_);
      });
      this.boundOnSession_ = null;
  ...
  var Transport = /* @__PURE__ */ function() {
    ...
    Transport2.forwardRequestToAmpScript = function forwardRequestToAmpScript(ampdoc, request) {
