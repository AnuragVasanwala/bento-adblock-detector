...
(function() {
  ...
  var _excluded5 = ["cards", "conversation", "limit", "momentid", "onError", "onLoad", "options", "requestResize", "style", "timelineScreenName", "timelineSourceType", "timelineUserId", "title", "tweetLimit", "tweetid"];
  function _extends9() {
  ...
  function defineElement() {
    var css = "bento-twitter{display:block;overflow:hidden;position:relative}bento-twitter:not(.i-amphtml-built){color:transparent!important}bento-twitter:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-twitter/1.0/amp-twitter.css*/";
    if (css) {
