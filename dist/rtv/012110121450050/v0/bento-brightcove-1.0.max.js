...
(function() {
  ...
  var _excluded5 = ["account", "autoplay", "embed", "muted", "player", "playlistId", "referrer", "videoId", "onPlayingState", "urlParams", "onLoad"];
  function _extends6() {
  ...
  function defineElement() {
    var css = "bento-brightcove{display:block;overflow:hidden;position:relative}bento-brightcove:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-brightcove/1.0/amp-brightcove.css*/";
    if (css) {
