...
(function() {
  ...
  var _excluded5 = ["autoplay", "doNotTrack", "onLoad", "videoid"];
  function _extends5() {
  ...
  function BentoVimeoWithRef(_ref, ref) {
    var _ref$autoplay = _ref.autoplay, autoplay = _ref$autoplay === void 0 ? false : _ref$autoplay, _ref$doNotTrack = _ref.doNotTrack, doNotTrack = _ref$doNotTrack === void 0 ? false : _ref$doNotTrack, onLoad = _ref.onLoad, videoid = _ref.videoid, rest = _objectWithoutPropertiesLoose5(_ref, _excluded5);
  ...
  function defineElement() {
    var css = "bento-vimeo{display:block;overflow:hidden;position:relative}bento-vimeo:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-vimeo/1.0/amp-vimeo.css*/";
    if (css) {
