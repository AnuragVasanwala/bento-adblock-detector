...
(function() {
  ...
  function BentoLightboxWithRef(_ref, ref) {
    var _ref$animation = _ref.animation, animation = _ref$animation === void 0 ? "fade-in" : _ref$animation, children = _ref.children, closeButtonAs = _ref.closeButtonAs, onAfterClose = _ref.onAfterClose, onAfterOpen = _ref.onAfterOpen, onBeforeOpen = _ref.onBeforeOpen, rest = _objectWithoutPropertiesLoose3(_ref, _excluded3);
  ...
  var _excluded6 = ["arrowPrevAs", "arrowNextAs", "children", "class", "extraSpace", "maxItemWidth", "minItemWidth", "maxVisibleCount", "minVisibleCount", "outsetArrows", "peek", "slideAlign"];
  function _extends11() {
  ...
  function DefaultArrow2(_ref) {
    var _objstr2;
    var ariaDisabled = _ref["aria-disabled"], by = _ref.by, className = _ref["class"], disabled = _ref.disabled, onClick = _ref.onClick, outsetArrows = _ref.outsetArrows;
    return createElement("div", {
      class: className
    }, createElement("button", {
      "aria-disabled": ariaDisabled,
  ...
  function defineElement() {
    var css = "bento-stream-gallery{display:block;overflow:hidden;position:relative}bento-stream-gallery:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-stream-gallery/1.0/amp-stream-gallery.css*/";
    if (css) {
