(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-stream-gallery",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpStreamGallery = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.getActionSource_ = function getActionSource_(trust) {
      return trust == ActionTrust.HIGH ? ActionSource.GENERIC_HIGH_TRUST : ActionSource.GENERIC_LOW_TRUST;
    };
