...
(function() {
  ...
  function defineElement() {
    var css = "bento-instagram{display:block;overflow:hidden;position:relative}bento-instagram:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-instagram/1.0/amp-instagram.css*/";
    if (css) {
