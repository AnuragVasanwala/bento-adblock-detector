(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-ad-network-fake-impl",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  function installGlobalNavigationHandlerForDoc(ampdoc) {
    registerServiceBuilderForDoc(ampdoc, TAG9, Navigation, true);
  }
  ...
  var AmpAdNetworkFakeImpl = /* @__PURE__ */ function(_AmpA4A) {
    ...
    _proto.sendXhrRequest = function sendXhrRequest(adUrl) {
      ...
      return _AmpA4A.prototype.sendXhrRequest.call(this, adUrl).then(function(response) {
        ...
        var headers = response.headers, status = response.status;
