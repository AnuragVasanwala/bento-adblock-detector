(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-twitter",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpTwitter = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.preconnectCallback = function preconnectCallback(opt_onLayout) {
      ...
      preconnect.preload(ampdoc, "https://platform.twitter.com/widgets.js", "script");
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      listenFor(iframe, MessageType.EMBED_SIZE, function(data) {
        _this2.updateForSuccessState_(data["height"]);
      }, true);
      listenFor(iframe, MessageType.NO_CONTENT, function() {
