...
(function() {
  ...
  function defineElement() {
    var css = "bento-video-iframe{display:block;overflow:hidden;position:relative}bento-video-iframe:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-video-iframe/1.0/amp-video-iframe.css*/";
    if (css) {
