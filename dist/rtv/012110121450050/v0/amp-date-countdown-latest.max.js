(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-date-countdown",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpDateCountdown = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.tickCountDown_ = function tickCountDown_(differentBetween) {
      ...
      if (this.whenEnded_ === "stop" && differentBetween < 1e3) {
        Services.actionServiceForDoc(this.element).trigger(this.element, "timeout", null, ActionTrust.LOW);
        this.win.clearInterval(this.countDownTimer_);
      }
