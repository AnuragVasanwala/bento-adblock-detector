(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-accordion",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function setStyles(element, styles) {
    for (var k4 in styles) {
      setStyle(element, k4, styles[k4]);
    }
  }
  ...
  var _excluded3 = ["animate", "as", "children", "expandSingleSection", "id"];
  var _excluded22 = ["animate", "as", "children", "expanded", "id", "onExpandStateChange"];
  var _excluded32 = ["as", "children", "class", "id", "role", "tabIndex"];
  var _excluded4 = ["as", "children", "class", "id", "role"];
  function _extends8() {
  ...
  function BentoAccordionWithRef(_ref, ref) {
    ...
    useEffect(function() {
      ...
      setExpandedMap(function(expandedMap2) {
        var newExpandedMap = {};
        var expanded = 0;
        for (var k4 in expandedMap2) {
          newExpandedMap[k4] = expandedMap2[k4] && expanded++ == 0;
        }
    ...
    var toggleExpanded = useCallback(function(id2, opt_expand) {
      setExpandedMap(function(expandedMap2) {
        ...
        resolvedPromise().then(function() {
          for (var k4 in expandedMap2) {
            var onExpandStateChange = eventMapRef.current[k4];
            if (onExpandStateChange && expandedMap2[k4] != newExpandedMap[k4]) {
              onExpandStateChange(newExpandedMap[k4]);
            }
          }
        });
        return newExpandedMap;
  ...
  function BentoAccordionSection(_ref3) {
    var _ref3$animate = _ref3.animate, defaultAnimate = _ref3$animate === void 0 ? false : _ref3$animate, _ref3$as = _ref3.as, Comp = _ref3$as === void 0 ? "section" : _ref3$as, children = _ref3.children, _ref3$expanded = _ref3.expanded, defaultExpanded = _ref3$expanded === void 0 ? false : _ref3$expanded, propId = _ref3.id, onExpandStateChange = _ref3.onExpandStateChange, rest = _objectWithoutPropertiesLoose3(_ref3, _excluded22);
  ...
  function BentoAccordionHeader(_ref4) {
    var _ref4$as = _ref4.as, Comp = _ref4$as === void 0 ? "div" : _ref4$as, children = _ref4.children, _ref4$class = _ref4["class"], className = _ref4$class === void 0 ? "" : _ref4$class, id = _ref4.id, _ref4$role = _ref4.role, role = _ref4$role === void 0 ? "button" : _ref4$role, _ref4$tabIndex = _ref4.tabIndex, tabIndex = _ref4$tabIndex === void 0 ? 0 : _ref4$tabIndex, rest = _objectWithoutPropertiesLoose3(_ref4, _excluded32);
  ...
  function BentoAccordionContent(_ref5) {
    var _objstr;
    var _ref5$as = _ref5.as, Comp = _ref5$as === void 0 ? "div" : _ref5$as, children = _ref5.children, _ref5$class = _ref5["class"], className = _ref5$class === void 0 ? "" : _ref5$class, id = _ref5.id, _ref5$role = _ref5.role, role = _ref5$role === void 0 ? "region" : _ref5$role, rest = _objectWithoutPropertiesLoose3(_ref5, _excluded4);
    var ref = useRef(null);
  ...
  function HeaderShim(sectionElement, _ref) {
    ...
    useLayoutEffect(function() {
      ...
      return function() {
        headerElement.removeEventListener("click", devAssert2(onClick));
      };
    }, [sectionElement, headerElement, id, role, onClick, ariaControls, ariaExpanded]);
    return _header || (_header = createElement("header", null));
  }
  ...
  var AmpAccordion = /* @__PURE__ */ function(_BaseElement) {
    ...
    _proto.triggerEvent = function triggerEvent(section, eventName, detail) {
      ...
      Services.actionServiceForDoc(section).trigger(section, eventName, event, ActionTrust.HIGH);
