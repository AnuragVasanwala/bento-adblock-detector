...
(function() {
  ...
  function BentoInlineGallery(_ref) {
    var children = _ref.children, rest = _objectWithoutPropertiesLoose3(_ref, _excluded3);
  ...
  // extensions/amp-inline-gallery/1.0/build/bento-inline-gallery.js
  function defineElement() {
    var css = "bento-inline-gallery,bento-inline-gallery-pagination,bento-inline-gallery-thumbnails{display:block}bento-inline-gallery{contain:layout}bento-inline-gallery-pagination,bento-inline-gallery-thumbnails{overflow:hidden;position:relative}bento-inline-gallery-pagination:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]),bento-inline-gallery-thumbnails:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-inline-gallery/1.0/amp-inline-gallery.css*/";
    if (css) {
      var style = document.createElement("style");
      style.textContent = css;
      document.head.appendChild(style);
    }
    customElements.define("bento-inline-gallery", BaseElement2.CustomElement(BaseElement2));
  }
  defineElement();
})();
