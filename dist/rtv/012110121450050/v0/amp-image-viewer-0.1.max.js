(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-image-viewer",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpImageViewer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      var laidOutPromise = haveImg ? resolvedPromise() : img.tagName === "IMG" ? loadPromise(img) : img.signals().whenSignal(CommonSignals.LOAD_END);
      if (!haveImg) {
