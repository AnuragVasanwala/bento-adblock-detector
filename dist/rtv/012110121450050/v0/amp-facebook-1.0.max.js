(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-facebook",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  var _excluded3 = ["allow", "allowFullScreen", "iframeStyle", "name", "title", "matchesMessagingOrigin", "messageHandler", "ready", "loading", "onReadyState", "sandbox", "src"];
  function _extends3() {
  ...
  function ProxyIframeEmbedWithRef(_ref, ref) {
    ...
    return createElement(IframeEmbed, _extends5({
      allow: allow,
  ...
  var _excluded5 = ["action", "colorscheme", "embedAs", "hideCover", "hideCta", "href", "includeCommentParent", "kdSite", "layout", "locale", "numPosts", "onLoad", "orderBy", "refLabel", "requestResize", "share", "showFacepile", "showText", "size", "smallHeader", "style", "tabs", "title"];
  function _extends6() {
  ...
  function BentoFacebookWithRef(_ref, ref) {
    var action = _ref.action, colorscheme = _ref.colorscheme, embedAs = _ref.embedAs, hideCover = _ref.hideCover, hideCta = _ref.hideCta, href = _ref.href, includeCommentParent = _ref.includeCommentParent, kdSite = _ref.kdSite, layout = _ref.layout, localeProp = _ref.locale, numPosts = _ref.numPosts, onLoad = _ref.onLoad, orderBy = _ref.orderBy, refLabel = _ref.refLabel, requestResize = _ref.requestResize, share = _ref.share, showFacepile = _ref.showFacepile, showText = _ref.showText, size = _ref.size, smallHeader = _ref.smallHeader, style = _ref.style, tabs = _ref.tabs, _ref$title = _ref.title, title = _ref$title === void 0 ? DEFAULT_TITLE : _ref$title, rest = _objectWithoutPropertiesLoose5(_ref, _excluded5);
    ...
    return createElement(ProxyIframeEmbed, _extends6({
      options: options,
      ref: ref,
      title: title
    }, rest, {
  ...
  var TYPE2 = "facebook";
  var AmpFacebook = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpFacebook2, _BaseElement);
    var _super = _createSuper4(AmpFacebook2);
    ...
    AmpFacebook2.getPreconnects = function getPreconnects(element) {
    ...
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-facebook"), 'expected global "bento" or specific "bento-facebook" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpFacebook2;
  }(BaseElement2);
  ...
  AmpFacebook["props"] = _extends11({}, BaseElement2["props"], {
    "embedAs": {
      attrs: ["data-embed-as"],
      parseAttrs: parseEmbed
    }
  });
  var AmpFacebookComments = /* @__PURE__ */ function(_AmpFacebook) {
    _inherits4(AmpFacebookComments2, _AmpFacebook);
    var _super2 = _createSuper4(AmpFacebookComments2);
    function AmpFacebookComments2() {
      return _super2.apply(this, arguments);
    }
    return AmpFacebookComments2;
  }(AmpFacebook);
  AmpFacebookComments["staticProps"] = {
    "embedAs": "comments"
  };
  var AmpFacebookLike = /* @__PURE__ */ function(_AmpFacebook2) {
    _inherits4(AmpFacebookLike2, _AmpFacebook2);
    var _super3 = _createSuper4(AmpFacebookLike2);
    function AmpFacebookLike2() {
      return _super3.apply(this, arguments);
    }
    return AmpFacebookLike2;
  }(AmpFacebook);
  AmpFacebookLike["staticProps"] = {
    "embedAs": "like"
  };
  var AmpFacebookPage = /* @__PURE__ */ function(_AmpFacebook3) {
    _inherits4(AmpFacebookPage2, _AmpFacebook3);
    var _super4 = _createSuper4(AmpFacebookPage2);
    function AmpFacebookPage2() {
      return _super4.apply(this, arguments);
    }
    return AmpFacebookPage2;
  }(AmpFacebook);
  AmpFacebookPage["staticProps"] = {
    "embedAs": "page"
  };
