(self.AMP=self.AMP||[]).push({m:0,v:"2110121450050",n:"amp-ad-network-doubleclick-impl",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  function groupAmpAdsByType(ampdoc, type, groupFn) {
  ...
  function installGlobalNavigationHandlerForDoc(ampdoc) {
    registerServiceBuilderForDoc(ampdoc, TAG3, Navigation, true);
  }
  ...
  function installUrlForDoc(ampdoc) {
    registerServiceBuilderForDoc(ampdoc, SERVICE2, Url, true);
  }
  ...
  var Installers = /* @__PURE__ */ function() {
    ...
    Installers2.installExtensionsInEmbed = function installExtensionsInEmbed(embed, extensionsService, ampdoc, extensions, preinstallCallback, opt_installComplete) {
    ...
    Installers2.installStandardServicesInEmbed = function installStandardServicesInEmbed(ampdoc) {
  ...
  var TOKEN_VALUE_1P = "";
  ...
  var AmpA4A = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.preinstallCallback_ = function preinstallCallback_(embedWin, ampdoc) {
  ...
  var AmpAdNetworkDoubleclickImpl = /* @__PURE__ */ function(_AmpA4A) {
    ...
    _proto.setPageLevelExperiments = function setPageLevelExperiments(urlExperimentId) {
      ...
      var storyAdPageOutlinkExpId = getExperimentBranch(this.win, StoryAdPageOutlink.ID);
