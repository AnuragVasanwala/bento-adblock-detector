...
(function() {
  ...
  function defineElement() {
    var css = "bento-video{display:block;overflow:hidden;position:relative}bento-video:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-video/1.0/amp-video.css*/";
    if (css) {
