(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-embedly-card",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  var AmpEmbedlyKey = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits3(AmpEmbedlyKey2, _PreactBaseElement);
    var _super = _createSuper3(AmpEmbedlyKey2);
  ...
  var _excluded5 = ["onLoad", "requestResize", "style", "title", "url"];
  function _extends10() {
  ...
  function BentoEmbedlyCardWithRef(_ref, ref) {
    var onLoad = _ref.onLoad, requestResize = _ref.requestResize, style = _ref.style, title = _ref.title, url = _ref.url, rest = _objectWithoutPropertiesLoose5(_ref, _excluded5);
  ...
  var BaseElement2 = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits4(BaseElement3, _PreactBaseElement);
    var _super = _createSuper4(BaseElement3);
  ...
  var AmpEmbedlyCard = /* @__PURE__ */ function(_BaseElement) {
    _inherits5(AmpEmbedlyCard2, _BaseElement);
    var _super = _createSuper5(AmpEmbedlyCard2);
