(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-mathml",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  var _excluded5 = ["formula", "inline", "onLoad", "requestResize", "style", "title"];
  function _extends10() {
  ...
  function BentoMathmlWithRef(props, ref) {
    var _objStr;
    var formula = props.formula, _props$inline = props.inline, inline = _props$inline === void 0 ? false : _props$inline, onLoad = props.onLoad, requestResize = props.requestResize, bentoMathmlStyles = props.style, _props$title = props.title, title = _props$title === void 0 ? "MathML formula" : _props$title, rest = _objectWithoutPropertiesLoose5(props, _excluded5);
    var _useState = useState(null), dimensions = _useState[0], setDimensions = _useState[1];
    var _useState2 = useState(false), allowDimensions = _useState2[0], setAllowDimensions = _useState2[1];
    var onLoadRef = useValueRef(onLoad);
    var requestResizeRef = useValueRef(requestResize);
    useEffect(function() {
      if (allowDimensions && dimensions) {
        onLoadRef.current == null ? void 0 : onLoadRef.current();
        requestResizeRef.current == null ? void 0 : requestResizeRef.current(dimensions);
      }
    ...
    var messageHandler = useCallback(function(e3) {
      ...
      if (data["type"] == MessageType.EMBED_SIZE) {
        var height = data.height, w4 = data.width;
        var width = inline ? w4 : void 0;
        setDimensions({
          height: height,
          width: width
        });
    ...
    var observerCb;
    var ioCallback2 = useCallback(function(_ref) {
    ...
    observerCb = useIntersectionObserver(ioCallback2);
    var observerCbRef = function observerCbRef2(proxyIframeEmbedHandle) {
      var iframeNode = proxyIframeEmbedHandle.node;
      observerCb(iframeNode == null ? void 0 : iframeNode.parentNode.parentNode);
    };
    var styles = useMemo(function() {
      return _extends10({}, allowDimensions && dimensions, bentoMathmlStyles);
    ...
    var proxyIframeEmbedRef = useMergeRefs([ref, observerCbRef]);
    if (!validProps(props)) {
      return null;
    }
  ...
  function validProps(_ref2) {
    var formula = _ref2.formula;
    if (!formula) {
  ...
  var AmpMathml = /* @__PURE__ */ function(_BaseElement) {
    ...
    _proto.init = function init() {
      var _this = this;
      return dict({
        "requestResize": function requestResize(_ref) {
          var height = _ref.height, width = _ref.width;
          return _this.attemptChangeSize(height, width);
        }
      });
    };
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
