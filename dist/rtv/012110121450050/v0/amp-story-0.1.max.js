(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-story",ev:"1.0",l:true,f:(function(AMP,_){
(function() {
  ...
  var actions = function actions2(state, action, data) {
    ...
    switch (action) {
      ...
      case Action.TOGGLE_SUPPORTED_BROWSER:
        return _extends({}, state, (_extends23 = {}, _extends23[StateProperty.SUPPORTED_BROWSER_STATE] = !!data, _extends23));
      case Action.TOGGLE_SHARE_MENU:
        return _extends({}, state, (_extends24 = {}, _extends24[StateProperty.PAUSED_STATE] = !!data, _extends24[StateProperty.SHARE_MENU_STATE] = !!data, _extends24));
      case Action.TOGGLE_SYSTEM_UI_IS_VISIBLE:
        return _extends({}, state, (_extends25 = {}, _extends25[StateProperty.SYSTEM_UI_IS_VISIBLE_STATE] = !!data, _extends25));
      case Action.TOGGLE_UI:
        ...
        return _extends({}, state, (_extends26 = {}, _extends26[StateProperty.UI_STATE] = data, _extends26));
      case Action.SET_GYROSCOPE_PERMISSION:
        return _extends({}, state, (_extends27 = {}, _extends27[StateProperty.GYROSCOPE_PERMISSION_STATE] = data, _extends27));
      case Action.SET_CONSENT_ID:
        return _extends({}, state, (_extends28 = {}, _extends28[StateProperty.CONSENT_ID] = data, _extends28));
      case Action.CHANGE_PAGE:
        return _extends({}, state, (_extends29 = {}, _extends29[StateProperty.CURRENT_PAGE_ID] = data.id, _extends29[StateProperty.CURRENT_PAGE_INDEX] = data.index, _extends29));
      case Action.SET_ADVANCEMENT_MODE:
        return _extends({}, state, (_extends30 = {}, _extends30[StateProperty.ADVANCEMENT_MODE] = data, _extends30));
      case Action.SET_NAVIGATION_PATH:
        return _extends({}, state, (_extends31 = {}, _extends31[StateProperty.NAVIGATION_PATH] = data, _extends31));
      case Action.SET_PAGE_IDS:
        return _extends({}, state, (_extends322 = {}, _extends322[StateProperty.PAGE_IDS] = data, _extends322));
      case Action.SET_PAGE_SIZE:
        return _extends({}, state, (_extends33 = {}, _extends33[StateProperty.PAGE_SIZE] = data, _extends33));
      case Action.SET_VIEWER_CUSTOM_CONTROLS:
        return _extends({}, state, (_extends34 = {}, _extends34[StateProperty.VIEWER_CUSTOM_CONTROLS] = data, _extends34));
      default:
  ...
  var AmpStory = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.installGestureRecognizers_ = function installGestureRecognizers_() {
      ...
      gestures.onGesture(SwipeXYRecognizer, function(gesture) {
        ...
        if (embedComponent.state !== EmbeddedComponentState.HIDDEN || _this6.storeService_.get(StateProperty.ACCESS_STATE) || !_this6.storeService_.get(StateProperty.SYSTEM_UI_IS_VISIBLE_STATE) || !_this6.storeService_.get(StateProperty.CAN_SHOW_NAVIGATION_OVERLAY_HINT)) {
      ...
      switch (uiState) {
        ...
        case UIType.VERTICAL:
          ...
          this.vsync_.mutate(function() {
            ...
            _this17.win.document.documentElement.classList.add("i-amphtml-story-vertical");
      ...
      if (isBrowserSupported) {
        if (fallbackEl) {
          ...
          this.layoutStory_().then(function() {
            ...
            _this18.mutateElement(function() {
              _this18.unsupportedBrowserLayer_.removeLayer();
            });
          });
        }
      } else {
        ...
        if (fallbackEl) {
          ...
          this.mutateElement(function() {
            _this18.element.appendChild(_this18.unsupportedBrowserLayer_.get());
          });
        }
      }
    };
    _proto.getPagesByDistance_ = function getPagesByDistance_() {
      ...
      Object.keys(distanceMap).forEach(function(pageId) {
        ...
        if (pageId === _this19.pages_[0].element.id && _this19.activePage_ === _this19.pages_[_this19.pages_.length - 1] && _this19.pages_.length > 1 && !_this19.viewer_.hasCapability("swipe")) {
          distance = 1;
        }
        if (!pagesByDistance[distance]) {
          pagesByDistance[distance] = [];
        }
        if (isExperimentOn(_this19.win, "amp-story-branching")) {
          var navigationPath = _this19.storeService_.get(StateProperty.NAVIGATION_PATH);
          var indexInStack = navigationPath.indexOf(_this19.activePage_.element.id);
          var maybePrev = navigationPath[indexInStack - 1];
          if (indexInStack > 0 && pageId === _this19.activePage_.element.id) {
    ...
    _proto.getPageDistanceMapHelper_ = function getPageDistanceMapHelper_(distance, map2, pageId) {
      ...
      page.getAdjacentPageIds().forEach(function(adjacentPageId) {
        ...
        map2 = _this20.getPageDistanceMapHelper_(distance + 1, map2, adjacentPageId);
      });
      return map2;
    };
      ...
      var preloadAllPages = function preloadAllPages2() {
        pagesByDistance.forEach(function(pageIds, distance) {
          pageIds.forEach(function(pageId) {
            var page = _this21.getPageById(pageId);
            page.setDistance(distance);
          });
        });
      };
      this.mutateElement(function() {
        if (!isExperimentOn(_this21.win, "story-load-first-page-only") || !prioritizeActivePage) {
          return preloadAllPages();
        }
        var activePageId = devAssert2(pagesByDistance[0][0]);
        new Promise(function(res, rej) {
          var page = _this21.getPageById(activePageId);
          page.setDistance(0);
          page.signals().whenSignal(CommonSignals.LOAD_END).then(res);
          _this21.storeService_.subscribe(StateProperty.CURRENT_PAGE_ID, rej);
        }).then(function() {
          return preloadAllPages();
        }, function() {
        });
    ...
    _proto.registerAndPreloadBackgroundAudio_ = function registerAndPreloadBackgroundAudio_() {
      ...
      this.activePage_.element.signals().whenSignal(CommonSignals.LOAD_END).then(function() {
        ...
        _this22.mediaPool_.register(backgroundAudioEl);
        return _this22.mediaPool_.preload(backgroundAudioEl);
      }).then(function() {
        _this22.backgroundAudioEl_ = childElement(_this22.element, function(el) {
    ...
    _proto.maybeLoadStoryEducation_ = function maybeLoadStoryEducation_() {
      ...
      this.mutateElement(function() {
        _this23.element.appendChild(_this23.win.document.createElement("amp-story-education"));
      });
    ...
    _proto.unmute_ = function unmute_() {
      ...
      var unmuteAllMedia = function unmuteAllMedia2() {
        _this24.playBackgroundAudio_();
        if (_this24.activePage_) {
          _this24.activePage_.unmuteAllMedia();
        }
      };
    ...
    _proto.initializeStoryNavigationPath_ = function initializeStoryNavigationPath_() {
      ...
      if (!navigationPath || !navigationPath.every(function(pageId) {
        return _this26.isActualPage_(pageId);
      })) {
        navigationPath = [];
      }
      this.storeService_.dispatch(Action.SET_NAVIGATION_PATH, navigationPath);
    ...
    _proto.replay_ = function replay_() {
      ...
      switchPromise.then(function() {
        _this27.pages_.forEach(function(page) {
