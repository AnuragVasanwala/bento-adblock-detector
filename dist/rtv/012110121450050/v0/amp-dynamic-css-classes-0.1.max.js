(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-dynamic-css-classes",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  function referrerDomain(ampdoc) {
    var referrer = Services.viewerForDoc(ampdoc).getUnconfirmedReferrerUrl();
    if (!referrer) {
      return "";
    }
    var _Services$urlForDoc$p = Services.urlForDoc(ampdoc.getHeadNode()).parse(referrer), hostname = _Services$urlForDoc$p.hostname;
    return hostname;
  }
  ...
  function addReferrerClasses(ampdoc) {
    ...
    Services.vsyncFor(ampdoc.win).mutate(function() {
  ...
  var AmpDynamicCssClasses = /* @__PURE__ */ function() {
    function AmpDynamicCssClasses2(ampdoc) {
