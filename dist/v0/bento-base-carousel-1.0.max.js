...
(function() {
  ...
  function defineElement() {
    var css = "bento-base-carousel{display:block;overflow:hidden;position:relative}bento-base-carousel:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-base-carousel/1.0/amp-base-carousel.css*/";
    if (css) {
