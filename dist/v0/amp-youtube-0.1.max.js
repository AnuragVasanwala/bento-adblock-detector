(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-youtube",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpYoutube = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      if (this.isLoop_ && !this.isPlaylist_) {
        this.unlistenLooping_ = listen(this.element, VideoEvents.ENDED, function(unusedEvent) {
    ...
    _proto.handleYoutubeMessage_ = function handleYoutubeMessage_(event) {
      ...
      if (eventType == "infoDelivery" && playerState != null) {
        ...
        redispatch(element, playerState.toString(), (_redispatch = {}, _redispatch[PlayerStates.PLAYING] = VideoEvents.PLAYING, _redispatch[PlayerStates.PAUSED] = VideoEvents.PAUSE, _redispatch[PlayerStates.ENDED] = [VideoEvents.ENDED, VideoEvents.PAUSE], _redispatch));
        return;
      }
