(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-delight-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpDelightPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.handleDelightMessage_ = function handleDelightMessage_(event) {
      ...
      var redispatched = redispatch(element, data["type"], (_redispatch = {}, _redispatch[DelightEvent.PLAYING] = VideoEvents.PLAYING, _redispatch[DelightEvent.PAUSED] = VideoEvents.PAUSE, _redispatch[DelightEvent.ENDED] = VideoEvents.ENDED, _redispatch[DelightEvent.MUTED] = VideoEvents.MUTED, _redispatch[DelightEvent.UNMUTED] = VideoEvents.UNMUTED, _redispatch[DelightEvent.AD_START] = VideoEvents.AD_START, _redispatch[DelightEvent.AD_END] = VideoEvents.AD_END, _redispatch));
      if (redispatched) {
        return;
      }
      switch (data["type"]) {
