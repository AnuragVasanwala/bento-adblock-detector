...
(function() {
  ...
  function makeJwplayerIframeSrc(playerId, playlistId, mediaId, contentSearch, contentRecency, contentBackfill, queryParams, consentParams) {
    ...
    url = addParamsToUrl(url, _extends({}, queryParams, {
  ...
  function onSetup(iframe, config, adCustParamsJson, adMacros) {
    ...
    var config_ = _extends6({}, tryParseJson(jsonConfig) || {}, restConfig);
  ...
  function defineElement() {
    var css = "bento-jwplayer{display:block;overflow:hidden;position:relative}bento-jwplayer:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-jwplayer/1.0/amp-jwplayer.css*/";
    if (css) {
