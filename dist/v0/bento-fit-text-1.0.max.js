...
(function() {
  ...
  var _excluded3 = ["children", "maxFontSize", "minFontSize"];
  function _extends3() {
  ...
  function BentoFitText(_ref) {
    var children = _ref.children, _ref$maxFontSize = _ref.maxFontSize, maxFontSize = _ref$maxFontSize === void 0 ? 72 : _ref$maxFontSize, _ref$minFontSize = _ref.minFontSize, minFontSize = _ref$minFontSize === void 0 ? 6 : _ref$minFontSize, rest = _objectWithoutPropertiesLoose3(_ref, _excluded3);
  ...
  function defineElement() {
    var css = "bento-fit-text{display:block;overflow:hidden;position:relative}bento-fit-text:not(.i-amphtml-built){color:transparent!important}bento-fit-text:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-fit-text/1.0/amp-fit-text.css*/";
    if (css) {
