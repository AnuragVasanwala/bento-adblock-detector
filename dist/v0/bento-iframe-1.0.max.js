...
(function() {
  ...
  var _excluded3 = ["allowFullScreen", "allowPaymentRequest", "iframeStyle", "onLoad", "referrerPolicy", "requestResize", "sandbox", "src", "srcdoc"];
  function _extends3() {
  ...
  function BentoIframe(_ref) {
    ...
    var viewabilityCb = function viewabilityCb2(entries) {
      ...
      postMessage(iframe, MessageType.INTERSECTION, dict({
    ...
    var handleSendIntersectionsPostMessage = useCallback(function(event) {
      ...
      if (event.source !== iframe.contentWindow || ((_event$data = event.data) == null ? void 0 : _event$data.type) !== MessageType.SEND_INTERSECTIONS) {
        return;
      }
    ...
    var handleEmbedSizePostMessage = useCallback(function(event) {
      var _event$data2;
      if (((_event$data2 = event.data) == null ? void 0 : _event$data2.type) !== MessageType.EMBED_SIZE) {
        return;
      }
  ...
  function defineElement() {
    var css = "bento-iframe{display:block;overflow:hidden;position:relative}bento-iframe:not(.i-amphtml-built){color:transparent!important}bento-iframe:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-iframe/1.0/amp-iframe.css*/";
    if (css) {
