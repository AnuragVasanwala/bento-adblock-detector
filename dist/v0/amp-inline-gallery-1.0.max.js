(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-inline-gallery",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function BentoInlineGalleryPagination(_ref) {
    var inset = _ref.inset, rest = _objectWithoutPropertiesLoose3(_ref, _excluded3);
    ...
    return createElement(Wrapper, _extends4({
      "aria-hidden": "true",
  ...
  function Numbers(_ref3) {
    ...
    }, createElement("span", null, currentSlide + 1), _span || (_span = createElement("span", null, " / ")), createElement("span", null, slideCount));
  }
  ...
  var AmpInlineGalleryPagination = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits3(AmpInlineGalleryPagination2, _PreactBaseElement);
    var _super = _createSuper3(AmpInlineGalleryPagination2);
    function AmpInlineGalleryPagination2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpInlineGalleryPagination2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-inline-gallery"), 'expected global "bento" or specific "bento-inline-gallery" experiment to be enabled');
      return _PreactBaseElement.prototype.isLayoutSupported.call(this, layout);
    };
  ...
  AmpInlineGalleryPagination["shadowCss"] = CSS2;
  ...
  var _excluded7 = ["aspectRatio", "children", "class", "loop"];
  function _extends13() {
  ...
  function BentoInlineGalleryThumbnails(_ref) {
    var aspectRatio = _ref.aspectRatio, children = _ref.children, _ref$class = _ref["class"], className = _ref$class === void 0 ? "" : _ref$class, _ref$loop = _ref.loop, loop = _ref$loop === void 0 ? false : _ref$loop, rest = _objectWithoutPropertiesLoose7(_ref, _excluded7);
  ...
  var AmpInlineGalleryThumbnails = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits4(AmpInlineGalleryThumbnails2, _PreactBaseElement);
  ...
  AmpInlineGalleryThumbnails["shadowCss"] = CSS3 + CSS4;
  ...
  function BentoInlineGallery(_ref) {
    var children = _ref.children, rest = _objectWithoutPropertiesLoose8(_ref, _excluded8);
  ...
  var AmpInlineGallery = /* @__PURE__ */ function(_BaseElement) {
    _inherits6(AmpInlineGallery2, _BaseElement);
    var _super = _createSuper6(AmpInlineGallery2);
