...
(function() {
  ...
  var _excluded4 = ["onLoad", "requestResize", "title", "url"];
  function _extends8() {
  ...
  function BentoWordPressEmbedWithRef(_ref, ref) {
    var onLoad = _ref.onLoad, requestResize = _ref.requestResize, _ref$title = _ref.title, title = _ref$title === void 0 ? "WordPress Embed" : _ref$title, url = _ref.url, rest = _objectWithoutPropertiesLoose4(_ref, _excluded4);
  ...
  function defineElement() {
    var css = "bento-wordpress-embed{display:block;overflow:hidden;position:relative}bento-wordpress-embed:not(.i-amphtml-built){color:transparent!important}bento-wordpress-embed:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-wordpress-embed/1.0/amp-wordpress-embed.css*/";
    if (css) {
