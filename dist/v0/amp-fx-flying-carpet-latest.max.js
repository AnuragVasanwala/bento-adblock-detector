(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-fx-flying-carpet",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
      ...
      var observer = new MutationObserver(function(changes) {
        for (var i = 0; i < changes.length; i++) {
          ...
          for (var n = 0; n < addedNodes.length; n++) {
            ...
            node.signals().whenSignal(CommonSignals.BUILT).then(_this3.layoutBuiltChild_.bind(_this3, node));
          }
        }
      });
