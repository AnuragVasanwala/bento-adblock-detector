(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-dailymotion",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpDailymotion = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.handleEvents_ = function handleEvents_(event) {
      ...
      redispatch(this.element, data["event"], (_redispatch = {}, _redispatch[DailymotionEvents.API_READY] = VideoEvents.LOAD, _redispatch[DailymotionEvents.END] = [VideoEvents.ENDED, VideoEvents.PAUSE], _redispatch[DailymotionEvents.PAUSE] = VideoEvents.PAUSE, _redispatch[DailymotionEvents.PLAY] = VideoEvents.PLAYING, _redispatch));
      switch (data["event"]) {
    ...
    _proto.mute = function mute() {
      ...
      this.playerReadyPromise_.then(function() {
        dispatchCustomEvent(_this4.element, VideoEvents.MUTED);
        _this4.muted_ = true;
      });
    };
    _proto.unmute = function unmute() {
      ...
      this.playerReadyPromise_.then(function() {
        dispatchCustomEvent(_this5.element, VideoEvents.UNMUTED);
        _this5.muted_ = false;
      });
    };
    _proto.showControls = function showControls() {
