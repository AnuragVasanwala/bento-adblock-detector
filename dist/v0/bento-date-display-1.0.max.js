...
(function() {
  ...
  var _excluded3 = ["datetime", "displayIn", "locale", "localeOptions", "render"];
  function _extends7() {
  ...
  function defineElement() {
    var css = "bento-date-display{display:block;overflow:hidden;position:relative}bento-date-display:not(.i-amphtml-built){color:transparent!important}bento-date-display:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-date-display/1.0/amp-date-display.css*/";
    if (css) {
