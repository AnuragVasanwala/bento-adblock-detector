...
(function() {
  ...
  var _excluded5 = ["autoplay", "loop", "videoid", "liveChannelid", "onLoad", "params", "credentials"];
  function _extends5() {
  ...
  function BentoYoutubeWithRef(_ref, ref) {
    var autoplay = _ref.autoplay, loop = _ref.loop, videoid = _ref.videoid, liveChannelid = _ref.liveChannelid, onLoad = _ref.onLoad, _ref$params = _ref.params, params = _ref$params === void 0 ? {} : _ref$params, credentials = _ref.credentials, rest = _objectWithoutPropertiesLoose5(_ref, _excluded5);
  ...
  function defineElement() {
    var css = "bento-youtube{display:block;overflow:hidden;position:relative}bento-youtube:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-youtube/1.0/amp-youtube.css*/";
    if (css) {
