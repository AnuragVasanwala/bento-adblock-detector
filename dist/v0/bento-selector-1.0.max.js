...
(function() {
  ...
  var _excluded = ["as", "disabled", "defaultValue", "form", "keyboardSelectMode", "value", "multiple", "name", "onChange", "role", "tabIndex", "children"];
  var _excluded2 = ["as", "class", "disabled", "focus", "index", "option", "role", "tabIndex"];
  function _extends5() {
  ...
  function BentoSelectorOption(_ref2) {
    var _objstr;
    var _ref2$as = _ref2.as, Comp = _ref2$as === void 0 ? "div" : _ref2$as, _ref2$class = _ref2["class"], className = _ref2$class === void 0 ? "" : _ref2$class, _ref2$disabled = _ref2.disabled, disabled = _ref2$disabled === void 0 ? false : _ref2$disabled, customFocus = _ref2.focus, index = _ref2.index, option = _ref2.option, _ref2$role = _ref2.role, role = _ref2$role === void 0 ? "option" : _ref2$role, tabIndex = _ref2.tabIndex, rest = _objectWithoutPropertiesLoose(_ref2, _excluded2);
    var ref = useRef(null);
  ...
  function defineElement() {
    var css = "bento-selector{display:block}bento-selector [option]{cursor:pointer}bento-selector[multiple] [option][selected]{cursor:pointer;outline:1px solid rgba(0,0,0,0.7)}bento-selector [disabled][option],bento-selector[disabled] [option],bento-selector[disabled] [selected],bento-selector [selected][disabled]{cursor:auto;opacity:0.4}bento-selector [option][selected]{cursor:auto;outline:1px solid rgba(0,0,0,0.7)}\n/*# sourceURL=/extensions/amp-selector/1.0/amp-selector.css*/";
    if (css) {
