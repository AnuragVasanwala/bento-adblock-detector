(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-install-serviceworker",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpInstallServiceWorker = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.maybeInstallUrlRewrite_ = function maybeInstallUrlRewrite_() {
      ...
      this.urlRewriter_ = new UrlRewriter_(ampdoc, urlMatchExpr, shellUrl, this.element);
  ...
  var UrlRewriter_ = /* @__PURE__ */ function() {
    function UrlRewriter_2(ampdoc, urlMatchExpr, shellUrl, element) {
      this.win = ampdoc.win;
