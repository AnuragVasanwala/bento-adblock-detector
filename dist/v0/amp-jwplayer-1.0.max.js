(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-jwplayer",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function serializeQueryString(params) {
    ...
    for (var k4 in params) {
      ...
      for (var i4 = 0; i4 < v3.length; i4++) {
        s3.push(urlEncodeKeyValue(k4, v3[i4]));
      }
    }
    return s3.join("&");
  }
  ...
  function makeJwplayerIframeSrc(playerId, playlistId, mediaId, contentSearch, contentRecency, contentBackfill, queryParams, consentParams) {
    ...
    url = addParamsToUrl(url, _extends2({}, queryParams, {
  ...
  var _AutoplayIconContent;
  var _excluded3 = ["autoplay", "class", "component", "controls", "loading", "loop", "mediasession", "noaudio", "onPlayingState", "onReadyState", "poster", "sources", "src", "style"];
  function _extends5() {
  ...
  function VideoWrapperWithRef(_ref, ref) {
    var _ref$autoplay = _ref.autoplay, autoplay = _ref$autoplay === void 0 ? false : _ref$autoplay, className = _ref["class"], _ref$component = _ref.component, Component = _ref$component === void 0 ? "video" : _ref$component, _ref$controls = _ref.controls, controls = _ref$controls === void 0 ? false : _ref$controls, loadingProp = _ref.loading, _ref$loop = _ref.loop, loop = _ref$loop === void 0 ? false : _ref$loop, _ref$mediasession = _ref.mediasession, mediasession = _ref$mediasession === void 0 ? true : _ref$mediasession, _ref$noaudio = _ref.noaudio, noaudio = _ref$noaudio === void 0 ? false : _ref$noaudio, onPlayingState = _ref.onPlayingState, onReadyState = _ref.onReadyState, poster = _ref.poster, sources = _ref.sources, src = _ref.src, style = _ref.style, rest = _objectWithoutPropertiesLoose3(_ref, _excluded3);
    useResourcesNotify();
    ...
    return createElement(ContainWrapper, {
      ...
      layout: true,
      paint: true
    }, load && createElement(Component, _extends5({}, rest, {
      ref: playerRef,
      loading: loading,
      muted: muted,
      loop: loop,
      ...
      onError: function onError(e3) {
        setReadyState(ReadyState.ERROR, e3);
  ...
  function Autoplay(_ref2) {
    ...
    }, _AutoplayIconContent || (_AutoplayIconContent = createElement(AutoplayIconContent, null))), displayOverlay && createElement("button", {
  ...
  var _excluded4 = ["loading", "unloadOnPause", "sandbox", "muted", "controls", "origin", "onCanPlay", "onMessage", "playerStateRef", "makeMethodMessage", "makeFullscreenMessage", "onIframeLoad"];
  function _extends6() {
  ...
  function VideoIframeInternalWithRef(_ref, ref) {
    ...
    return createElement("iframe", _extends6({}, rest, {
      ref: iframeRef,
  ...
  function VideoIframeWithRef(props, ref) {
    return createElement(VideoWrapper, _extends6({
      ref: ref
    }, props, {
  ...
  var _excluded5 = ["adCustParams", "adMacros", "autoplay", "config", "consentParams", "contentBackfill", "contentRecency", "contentSearch", "mediaId", "onLoad", "onPlayingState", "playerId", "playlistId", "queryParams"];
  ...
  function BentoJwplayerWithRef(props, ref) {
    ...
    return createElement(VideoIframe, _extends7({
      ref: ref,
      playerStateRef: playerStateRef,
      src: src,
  ...
  function onSetup(iframe, config, adCustParamsJson, adMacros) {
    var _ref = config || {}, jsonConfig = _ref.json, restConfig = _objectWithoutPropertiesLoose5(_ref, _excluded22);
    var config_ = _extends7({}, tryParseJson(jsonConfig) || {}, restConfig);
  ...
  function createSlot(element, name, defaultProps, as) {
    ...
    if (!as) {
      return createElement(Slot, _extends9({}, defaultProps || EMPTY, {
        name: name
      }));
    }
  ...
  BaseElement3["props"] = {
    ...
    "adMacros": {
      attrPrefix: "data-ad-macro-"
    },
    "config": {
      attrPrefix: "data-config-"
    },
    "autoplay": {
      attr: "autoplay",
      type: "boolean"
