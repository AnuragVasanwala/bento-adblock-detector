...
(function() {
  ...
  var _excluded4 = ["color", "onLoad", "playlistId", "secretToken", "trackId", "visual"];
  function _extends8() {
  ...
  function BentoSoundcloud(_ref) {
    var color = _ref.color, onLoad = _ref.onLoad, playlistId = _ref.playlistId, secretToken = _ref.secretToken, trackId = _ref.trackId, _ref$visual = _ref.visual, visual = _ref$visual === void 0 ? false : _ref$visual, rest = _objectWithoutPropertiesLoose4(_ref, _excluded4);
    var iframeRef = useRef(null);
  ...
  function defineElement() {
    var css = "bento-soundcloud{display:block;overflow:hidden;position:relative}bento-soundcloud:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-soundcloud/1.0/amp-soundcloud.css*/";
    if (css) {
