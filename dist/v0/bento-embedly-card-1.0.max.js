...
(function() {
  ...
  // extensions/amp-embedly-card/1.0/build/bento-embedly-card.js
  function defineElement() {
    var css = "bento-embedly-card{display:block;overflow:hidden;position:relative}bento-embedly-card:not(.i-amphtml-built)>:not([placeholder]):not(.i-amphtml-svc){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-embedly-card/1.0/amp-embedly-card.css*/";
    if (css) {
      var style = document.createElement("style");
      style.textContent = css;
      document.head.appendChild(style);
    }
    customElements.define("bento-embedly-card", BaseElement2.CustomElement(BaseElement2));
  }
  defineElement();
})();
