(self.AMP=self.AMP||[]).push({m:0,v:"2110121450047",n:"amp-video-iframe",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpVideoIframe = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.getMetadata_ = function getMetadata_() {
      ...
      var _this$getAmpDoc$getRo = this.getAmpDoc().getRootNode(), documentElement = _this$getAmpDoc$getRo.documentElement, title = _this$getAmpDoc$getRo.title;
      return dict({
        "sourceUrl": sourceUrl,
