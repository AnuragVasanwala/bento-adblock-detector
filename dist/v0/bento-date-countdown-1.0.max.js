...
(function() {
  ...
  var _excluded3 = ["datetime", "whenEnded", "locale", "biggestUnit", "countUp", "render"];
  function _extends7() {
  ...
  function getYDHMSFromMs(ms, biggestUnit, countUp) {
    ...
    var d3 = TimeUnit[biggestUnit] == TimeUnit.DAYS ? supportBackDate(Math.floor(ms / MILLISECONDS_IN_DAY)) : 0;
  ...
  function defineElement() {
    var css = "bento-date-countdown{display:block;overflow:hidden;position:relative}bento-date-countdown:not(.i-amphtml-built){color:transparent!important}bento-date-countdown:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-date-countdown/1.0/amp-date-countdown.css*/";
    if (css) {
