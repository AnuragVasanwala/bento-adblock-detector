...
(function() {
  ...
  function installGlobalNavigationHandlerForDoc(ampdoc) {
    registerServiceBuilderForDoc(ampdoc, TAG10, Navigation, true);
  }
  ...
  var CSS2 = "amp-story-cta-layer{display:block!important;position:absolute!important;top:80%!important;right:0!important;bottom:0!important;left:0!important;margin:0!important;z-index:3!important}\n/*# sourceURL=/extensions/amp-story-auto-ads/0.1/amp-story-auto-ads-inabox.css*/";
  ...
  function maybeRenderInaboxAsStoryAd(ampdoc) {
    ...
    installStylesForDoc(ampdoc, CSS3 + CSS2, function() {
    });
  ...
  function registerIniLoadListener(ampdoc) {
    var win = ampdoc.win;
    var root = ampdoc.getRootNode();
    whenContentIniLoadMeasure(ampdoc, win, Services.viewportForDoc(ampdoc).getLayoutRect(root.documentElement || root.body || root)).then(function() {
